...
The previous root-level module infographic has been retired; see the [module architecture map](docs/module-map.md) for a contributor-oriented overview of the current architecture.
